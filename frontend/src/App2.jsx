function App2() {
  return (
    <>
      <div className="bg-indigo-50 flex flex-col h-screen items-center justify-center">
        ...
        <div className="h-200 pb-30 flex-col bg-white w-130 flex items-center justify-center rounded-2xl  shadow-2xl shadow-blue-500 ">
  ...
  <p className="pr-55 font-medium">Password:</p>
          ...
          <div className="flex border-1 rounded-2xl h-10 p-2 bg-indigo-50">
          ...
          <button className="bg-gray-50 text-gray-600 h-15 w-40 rounded-2xl font-bold" > Back to home</button>
        </div>
